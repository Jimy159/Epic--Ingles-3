...
{
    public FragmentType.Type currentType;
    ...
    public void PickUp(GameObject obj)
    {
        ...
        FragmentType typeObj = obj.GetComponent<FragmentType>();
        interactable = typeObj.interactable;
        interactable.enabled = false;
        typeObj.pointOfInterest.enabled = true;
    ...
    public void ChangeObject()
    {
        if (currentObject != null)
        {
            FragmentType typeObj = currentObject.GetComponent<FragmentType>();
            if (typeObj != null)
            {
